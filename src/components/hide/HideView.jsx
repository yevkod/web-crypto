    ...
    return (
        <div className='pt-[90px] pb-[90px]'>
            <div>
                ...
                <div>
                    <span className='text-[55px]'>Hide it all. Go Blank.</span>
                </div>
            </div>
            <div className='grid grid-cols-1 md:grid-cols-2 pt-8 lg:grid-cols-3 max-w-[90rem] mx-auto px-5'>
                {hideArray.map((item) => (
                    <div className='flex flex-col h-full w-full max-w-[392px] max-h-[440px] bg-[#E7F1FB] py-28 px-5' style={{ backgroundImage: `url(${item.background})` }}
                    >
