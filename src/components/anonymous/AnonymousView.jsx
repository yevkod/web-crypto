...
export const AnonymousView = () => {
    return (
        <div className='pt-[50px] lg:pt-[90px] pb-[50] lg:pb-[90px]'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-0 mx-auto max-w-[90rem]'>
                <div className='flex flex-col justify-center text-left max-w-[559px] px-5 mx-auto lg:mx-0'>
                    <div className='uppercase text-[12px] pl-5'>
                        <span>Why go blank</span>
                    </div>
                    <div className='[font-size:_clamp(2em,4vw,58px)] lg:leading-[65px] pt-5 hover:scale-105 cursor-pointer transition-all'>
                ...
                <div className='flex justify-center hover:scale-105 cursor-pointer transition-all px-5 lg:px-0'>
